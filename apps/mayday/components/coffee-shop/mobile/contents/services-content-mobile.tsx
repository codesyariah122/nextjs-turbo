...
const ServicesContentMobile = () => {
  return (
    <section>
      <div className="container mx-auto w-[200px] h-12">
        <div className="w-[99px] h-1 absolute left-[20px] top-[2450px] rounded-xl bg-[#ff902b]" />
        <p className="absolute left-[20px] top-[2350px] text-[32px] font-semibold text-left text-black">
          How to use delivery service
        </p>
      </div>
      <div className="w-[10px] h-[290px]">
        <div className="flex flex-col justify-start items-center w-[371px] h-[290px] absolute -left-[10px] top-[2490px]  gap-[15px] px-6 py-4">
          <img
        ...
        <div className="flex flex-col justify-center items-center w-[365px] h-[290px] absolute -left-[10px] top-[2790px]   gap-6 px-6 py-4">
          <img
        ...
        <div className="flex flex-col justify-start items-center w-[370px] h-[290px] absolute -left-[10px] top-[3090px]  gap-[17px] px-6 py-4">
