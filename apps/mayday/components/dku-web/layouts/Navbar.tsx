...
const Header = () => {
  ...
  return (
    <nav className="border-gray-30 bg-white dark:bg-gray-30 dark:border-gray-30">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div>
          <a href="#" className="flex items-center">
            <img
              src="/dku-asset/logo/logo-dku.png"
        ...
        <div>
          <button
            ...
            className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 cursor-pointer"
          >
            <svg
              aria-hidden="true"
